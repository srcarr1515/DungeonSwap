...
var blueprint = [
	...
	{"args": {"action" : "spawn_action", "action_object": "Explosion", "start_position": "event_location", "emitter": true, "call": [{"func": "set_modulate", "params": [Color(1.1,0.71,0.15,0.83)]}, 
	{"func": "set_scale", "params": [Vector2(0.6,0.5)]}]}, "transition_cue": ["on_destroyed"]}
]
