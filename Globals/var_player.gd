...
var skill_dict = {
	"holy_bolt": {'label': 'Holy Bolt', 'description': 'Shoot a ball of holy energy.', 'skill_name': "holy_bolt", "skill_type": "spell", "cooldown": 20, "atk_power": 5, "target_type": "target"},
	"faith_healing": {'label': 'Faith Healing', 'description': 'Heal one ally with the power of faith.', 'skill_name': "faith_healing", "skill_type": "spell", "cooldown": 10, "atk_power": 10, "target_type": "target"},
	"resurrect": {'label': 'Resurrect', 'description': 'Revive a fallen ally.', 'skill_name': "resurrect", "skill_type": "spell", "cooldown": 60, "atk_power": 10, "target_type": "tile"},
	"runic_wall": {'label': 'Runic Wall', 'description': 'Summon a wall of pure energy.', 'skill_name': "runic_wall", "skill_type": "summon", "cooldown": 40, "atk_power": 0, "target_type": "tile"},
	"energy_nova": {'label': 'Energy Nova', 'description': 'Conjure surrounding blast of energy. 2 charges.','skill_name': "energy_nova", "skill_type": "spell", "cooldown": 100, "atk_power": 2, "charges": 3, "auto-deploy": true, "target_type": "auto-deploy"},
	"eldritch_blitz": {'label': 'Eldritch Blitz', 'description': 'Call down a bolt of eldritch lightning. 3 charges.', 'skill_name': "eldritch_blitz", "skill_type": "spell", "cooldown": 120, "atk_power": 10, "charges": 3, "target_type": "target"},
	"dynamite": {'label': 'Dynamite', 'description': 'Create an explosion with dynamite.', 'skill_name': "dynamite", "skill_type": "spell", "cooldown": 40, "atk_power": 10, "target_type": "target"},
	"six_shooter": {'label': 'Six Shooter', 'description': 'Provide cover fire with a six-shooter pistol.', 'skill_name': "six_shooter", "skill_type": "spell", "cooldown": 30, "atk_power": 2, "charges": 6, "target_type": "target"},
	"sharpshoot": {'label': 'Sharpshoot', 'description': 'Perform a carefully aimed gun shot.', 'skill_name': "sharpshoot", "skill_type": "spell", "cooldown": 60, "atk_power": 20, "target_type": "target"}
}
